...
public class PageQueryUtil {
	...
	public static  final int DEFAULT_PAGESIZE = 15;//默认每页显示记录数
	
	private int pageSize;// 每页显示的条数
	private int recordCount;// 总共的条数
	private int currentPage;// 当前页面

	public PageQueryUtil(int pageSize, int recordCount, int currentPage) {
	...
	// 构造方法
	public PageQueryUtil(int pageSize, int recordCount) {
