...
<form name="thisform" id="from557982744" method="post" class="form-horizontal" >
	...
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}姓名：</label>
		<div class="col-sm-6 pl-0">
			<input type="text"  value=""
				class="form-control input-text span2" 
				placeholder="${productType.name}姓名/昵称" id="" name="name">
		</div>
	</div> 
	
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">达人特色：</label>
		<div class="col-sm-6 pl-0">
			<input type="text"  value=""
				class="form-control input-text span2" 
				placeholder="请介绍一下" id="" name="title">
		</div>
	</div>
	
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}头像：</label>
		<div class="col-sm-6 pl-0">
...
$("#previewfid1739669697").on("click",function() {
	...
	<!-- 
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}住址：</label>
