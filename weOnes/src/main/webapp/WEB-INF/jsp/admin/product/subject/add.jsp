...
<form name="thisform" id="from557982744" method="post" class="form-horizontal" >
	...
	<div class="row form-group">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}类型：</label>
	...
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}名称：</label>
		<div class="col-sm-6 pl-0">
			<input type="text"  value=""
				class="form-control input-text span2" 
				placeholder="主题名称" id="" name="name">
		</div>
	</div> 
	
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}标题：</label>
		<div class="col-sm-6 pl-0">
			<input type="text"  value=""
				class="form-control input-text span2" 
				placeholder="主题标题" id="" name="title">
		</div>
	</div>
	...
	<div class="row form-group">
		<label class="col-sm-2 control-label  pl-0 pr-5"><span
			class="required">*</span>主题背景：</label>
		<div class="col-sm-6 pl-0 uploadimgurl">
			<div class="sqImg" style="z-index: 10;">
				<input type="file" id="fid1739669697" name="uploadFile"
					style="opacity: 0; position: absolute; top: 0px; left: 0px; width: 200px; height: 100%;">
				<img name="imgurl" class="showimg" src="" width="100%" height="100%">
	...
	<div class="form-group normal-form">
		<label class="col-sm-2 control-label  pl-0 pr-5">${productType.name}封面：</label>
		<div class="col-sm-6 pl-0">
...
<script>
 //获取图片名称到input框 中
	...
	$("#fid1739669697").on("change", function() {
	 ...
	 $(".uploadimgurl").on('change',"#fid1739669697", function() {
